...
<p align="center">
	<img src="https://img1.daumcdn.net/thumb/R1280x0/?scode=mtistory2&fname=https%3A%2F%2Fblog.kakaocdn.net%2Fdn%2F8o760%2FbtqEmLDpBqG%2FdMCo5LL4VIdEtpgrpRUb10%2Fimg.png" alt="binary search" />
</p>
...
-   탐색의 시간 복잡도는 트리의 높이를 h라고 할 때 **O(h)** 이다.
    ...
    <br />
    <p align="center">
    	<img src="https://comscigate.com/ciips/niemann/s_fig33.gif" />
    </p>
...
-   이진탐색 트리의 순회는 중위 순회 (in order) 방식이다. (왼쪽 - 루트 - 오른쪽)
    ...
    <br />
    <p align="center">
    	<img src="https://comscigate.com/ciips/niemann/s_fig32.gif" />
    </p>
    <br />
...
-   이진탐색트리의 삽입 연산은 루트노드에서 탐색을 시작해 서브트리가 없는 잎새 노드에서 이뤄진다.
    ...
    <br />
    <p align="center">
    	<img src="./Binary Search Insert.png" />
    </p>
    <br />
